...
{
    window = new FujicoinGUI(m_node, platformStyle, networkStyle, 0);
...
void FujicoinApplication::addWallet(WalletModel* walletModel)
{
#ifdef ENABLE_WALLET
...
void FujicoinApplication::removeWallet()
{
#ifdef ENABLE_WALLET
