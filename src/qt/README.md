...
Used to process BIP21 and BIP70 (see https://github.com/bitcoin/bitcoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a fujicoin:... link from a browser).
...
* `fujicoinunits.(h/cpp)`: BTC / mBTC / etc handling
* `callback.h`
